        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    {/* Logo Here */}
                    <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Protect privacy. A web app made by me.</p>
                    <a href="https://github.com/alexdivadi" className="py-2.5 px-5 h-9 block w-fit bg-indigo-600 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0">
                        My GitHub
                    </a>
                </div>
                {/*End Col*/}
                <div className="lg:mx-auto text-left ">
                    <h4 className="text-lg text-gray-900 font-medium mb-7">FaceBlur</h4>
                ...
                <div className="lg:mx-auto text-left ">
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6"><a href="https://github.com/alexdivadi/faceblur/issues" className="text-gray-600 hover:text-gray-900">Report an Issue</a></li>
                        <li><a href="https://github.com/alexdivadi/faceblur" className=" text-gray-600 hover:text-gray-900">See Repo</a></li>
                    </ul>
                </div>
            </div>
            {/* Grid */}
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 "><a href="/">Faceblur</a> 2024, All rights reserved.</span>
                    <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                        {/* <a href="#" className="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#33CCFF] hover:bg-gray-900">
                        ...
                        <a href="#" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-gray-900 to-gray-900  
                        ">
                        ...
                        <a href="#" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF]  hover:bg-gray-900 ">
                        ...
                        <a href="#" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#FF0000]  hover:bg-gray-900 ">
